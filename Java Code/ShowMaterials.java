 ...
 */
public class ShowMaterials extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Materials Query");
        ...
        tableMaterials.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MATERIAL_CODE", "CIF", "EDITION_CODE"
            }
        ));
        jScrollPane1.setViewportView(tableMaterials);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        try {
            this.controller.showMaterials(tableMaterials, "MATERIAL");
     ...
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ShowMaterials().setVisible(true);
            }
        });
    }
